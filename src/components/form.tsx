    ...
    return (
        <div className="min-h-screen bg-gray-100 flex flex-col items-center justify-center p-4">
            ...
            <textarea
                ...
                rows={5}
            />
            <button onClick={async () => await createSharedText()} className="bg-blue-500 text-white px-6 py-2 rounded-lg shadow-md hover:bg-blue-600 transition-all duration-200">
                シェアする
            </button>
        </div>
    );
